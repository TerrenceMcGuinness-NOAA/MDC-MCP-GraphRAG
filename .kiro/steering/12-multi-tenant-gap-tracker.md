...
| F | Fortran parse failures (15% / 1,020 files) | MEDIUM | gw_v17 | SPEC READY | `.kiro/specs/fortran-parse-fallback/` (requirements + design + tasks DONE) | Regex-based CALL/USE fallback when fparser2 fails. 8 tasks / 5 waves. Implementation pending (CLI). Would recover relationships from ~1,020 files. |
