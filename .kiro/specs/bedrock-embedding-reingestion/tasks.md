...
- [ ] 1. Create titan1024 OpenSearch indices
  - [ ] 1.1 Run index creation script
  ...
  - [ ] 1.2 Verify indices exist
    - Query `_cat/indices?v` and confirm 10 total indices (5 mpnet768 + 5 titan1024)
    - _Requirements: 1.5_

- [ ] 2. Re-ingest all 5 collections with Bedrock Titan embeddings
  - [ ] 2.1 Ingest code-with-context (~60,576 docs — largest, run first)
...
- [ ] 4. Create ground truth and run benchmark
  ...
  - [ ] 4.2 Run benchmark: titan1024 vs mpnet768
...
- [ ] 5. Test Matryoshka queries with Nova embeddings
  - [ ] 5.1 Create nova1024 index and ingest subset
    - `node scripts/create-opensearch-indices.js --model nova1024`
    - Ingest at least 100 docs from workflow-docs using nova1024
    - _Requirements: 7.1_
  - [ ] 5.2 Test MatryoshkaQuery at dimensions 256, 512, 1024
    - Run same queries at each dimension level
    - Document quality/latency tradeoff
    - _Requirements: 7.2, 7.3, 7.4_

- [ ] 6. Establish drift detection baselines
  - [ ] 6.1 Run drift detector on all 5 titan1024 collections
...
- [ ] 7. Validate hybrid search with titan1024
  - [ ] 7.1 Run 5+ hybrid search queries against titan1024 indices
...
- [ ] 9. Documentation and wrap-up
  - [ ] 9.1 Update CHANGELOG.md with Bedrock re-ingestion results
  - [ ] 9.2 Update steering file with Phase 52 completion
