...
- [ ] 1. Create the shared smoke query module
  - [ ] 1.1 Create `mcp_server_python/src/tools/smoke_queries.py` with dataclasses and registry
  ...
  - [ ] 1.2 Implement the 9 per-module smoke query functions in `smoke_queries.py`
...
- [ ] 2. Integrate smoke queries into the health check tool
  - [ ] 2.1 Modify `mcp_server_python/src/tools/utility.py` to wire in `SmokeQueryRegistry`
...
- [ ] 3. Checkpoint - Verify health check integration
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Create the standalone CLI script
  - [ ] 4.1 Create `mcp_server_python/scripts/smoke_test_tools.py`
...
- [ ] 5. Checkpoint - Run standalone script against live backends
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 6. End-to-end verification via MCP tool call
  - [ ] 6.1 Verify `mcp_health_check(functional=True)` returns the Functional Validation section
...
- [ ] 7. Final checkpoint - All verification complete
  - Ensure all tests pass, ask the user if questions arise.
