...
%% Section title formatting - smaller, more compact for two-column layout
%% Using raggedright to prevent ugly word spacing in narrow columns
\titleformat{\section}
  {\normalfont\large\bfseries\raggedright}{\thesection.}{0.5em}{}
\titleformat{\subsection}
  {\normalfont\normalsize\bfseries\raggedright}{\thesubsection}{0.5em}{}
\titleformat{\subsubsection}
  {\normalfont\small\bfseries\raggedright}{\thesubsubsection}{0.5em}{}
