...
\title{
    ...
    {\LARGE\textcolor{noaalight}{AI-Assisted Infrastructure for\\NOAA's GFS Software Development Initiative}}\\[1.8em]
    {\Huge\bfseries\textcolor{noaablue}{MCP/RAG System Architecture}}\\[1.5em]
...
\author{
    ...
    {\small Claude Opus 4.5 (Anthropic) - AI Pair Programming Assistant}
}
...
\begin{tikzpicture}
    \node[draw=noaablue, fill=noaablue!10, rounded corners=8pt, 
          minimum width=14cm, minimum height=4.5cm, align=center] (cap) {
        \begin{minipage}{13cm}
        \centering
        ...
        \begin{tabular}{cl}
            ...
            \textcolor{chromagreen}{\checkmark} & COTS LLM independence - works with Claude, GPT-4, Gemini, \ldots
        \end{tabular}
        \end{minipage}
    };
\end{tikzpicture}
