    ...
    def _register_builtins(self) -> None:
        builtins = [
            ...
            ModelProfile(
                short_name="nova256",
                provider="bedrock",
                model_id="amazon.nova-multimodal-embed-v1",
                dimensions=256,
                supports_matryoshka=True,
                supports_multimodal=True,
                provider_params={"outputEmbeddingLength": 256},
            ),
            ModelProfile(
                short_name="nova512",
                provider="bedrock",
                ...
                supports_matryoshka=True,
                supports_multimodal=True,
                provider_params={"outputEmbeddingLength": 512},
            ),
            ModelProfile(
                short_name="nova1024",
                provider="bedrock",
            ...
            ModelProfile(
                ...
                supports_matryoshka=True,
                supports_multimodal=True,
                provider_params={"outputEmbeddingLength": 3072},
            ),
        ]
        for p in builtins:
