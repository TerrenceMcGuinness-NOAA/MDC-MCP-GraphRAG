...
Upgrade from all-MiniLM-L6-v2 (384-dim) for 50-100% better domain understanding
"""
...
# Documentation sources with metadata
DOCUMENTATION_SOURCES = {
    'tier1_critical': [
        {
            'name': 'global-workflow',
            'url': 'https://global-workflow.readthedocs.io/en/latest/',
            'sitemap': 'https://global-workflow.readthedocs.io/en/latest/sitemap.xml',
            'type': 'readthedocs',
            'priority': 1,
        ...
        },
        {
            ...
            'sitemap': 'https://nws-hpc-standards.readthedocs.io/en/latest/sitemap.xml',
            'type': 'readthedocs',
            'priority': 1,
        ...
        },
        {
            ...
            'sitemap': 'https://noaa-emcufs-utils.readthedocs.io/en/latest/sitemap.xml',
            'type': 'readthedocs',
            'priority': 1,
    ...
    'tier2_infrastructure': [
        {
            ...
            'sitemap': 'https://ufs-weather-model.readthedocs.io/en/latest/sitemap.xml',
            'type': 'readthedocs',
            'priority': 2,
        ...
        },
        {
            ...
            'sitemap': 'https://wxflow.readthedocs.io/en/latest/sitemap.xml',
            'type': 'readthedocs',
            'priority': 2,
        ...
        },
        {
            ...
            'sitemap': None,  # GitHub Pages, manual crawl
            'type': 'github_pages',
            'priority': 2,
    ...
    'tier3_build_system': [
        {
            ...
            'sitemap': 'https://spack-stack.readthedocs.io/en/latest/sitemap.xml',
            'type': 'readthedocs',
            'priority': 2,
            'description': 'Spack-stack build system (current, replaces hpc-stack)'
        }
    ],
    'tier4_reference': [
        {
