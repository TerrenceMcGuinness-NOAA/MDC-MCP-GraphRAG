...
|--------|-----------|----------|
| WorkflowInfoTools | `get_workflow_structure`, `get_system_configs`, `describe_component` | Filesystem only |
...
| EE2ComplianceTools | `analyze_ee2_compliance`, `scan_repository_compliance`, `search_ee2_standards` | ChromaDB |
